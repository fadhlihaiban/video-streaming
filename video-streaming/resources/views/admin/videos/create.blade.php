                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form method="POST" action="{{ route('admin.videos.store') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input id="youtube_id" class="block mt-1 w-full border-gray-300 rounded-md shadow-sm" type="text" name="youtube_id" value="{{ old('youtube_id') }}" required />
